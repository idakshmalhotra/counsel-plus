  ...
  return (
    <div className="mb-6">
      ...
      <div className="relative group">
        <select
          className={`w-full px-4 py-3 border-2 rounded-xl transition-all duration-200 bg-white appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-orange-500/20 ${
            hasError 
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
          {hasError ? (
            ...
            <FiChevronDown className={`h-5 w-5 transition-colors duration-200 ${
